...
class ClaudeClient:
    def __init__(self, api_key: str):
        ...
        self.system_prompt = (
            ...
            "1. Użyj list_layers aby zobaczyć co jest w projekcie\n"
    ...
    def _call_api(self, messages: list) -> dict:
        ...
        try:
            ...
            raise Exception(f"Blad API ({e.code}): {body.get('error', {}).get('message', str(body))}")

    def chat(self, user_message: str, on_tool_call=None) -> str:
        """
        Agentic loop: sends message, handles tool_use in a loop
        until Claude returns stop_reason == 'end_turn'.
        on_tool_call(tool_name, tool_input) -- UI callback showing what agent is doing
        """
        ...
        while True:
            ...
            # Agent wants to call tools -- execute and return results
            tool_results = []
